...
public class CachorrosApiGetV4Test {
    ...
    @Test
    @DisplayName("GET /pets?tipo=CACHORRO traz somente cachorros")
    void testGetSomenteCachorros() {
        getRequisicao().param("tipo","CACHORRO").get().then()
                .assertThat()
                .body("$", everyItem(hasEntry("tipo","CACHORRO")));
    }
